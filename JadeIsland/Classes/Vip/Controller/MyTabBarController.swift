...
class MyTabBarController: UITabBarController {
    ...
    func addChildViewControllers() {
        setChildViewController(HomeTableViewController(), title: "首页", imageName: "home_tabBar", selectedImageName: "home_tabBar_selected")
        setChildViewController(TradeTableViewController(), title: "投资", imageName: "financial_tabBar", selectedImageName: "financial_tabBar_selected")
        setChildViewController(VipViewController(), title: "会员", imageName: "more_tabBar", selectedImageName: "more_tabBar_selected")
        setChildViewController(MineTableViewController(), title: "我的", imageName: "mine_tabBar", selectedImageName: "mine_tabBar_selected")
